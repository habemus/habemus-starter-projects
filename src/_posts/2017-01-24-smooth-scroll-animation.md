...
layout: post
author: habemus
title:  Smooth Scroll with Animation
lang:   en
...
description: A starter HTML5+CSS3+JS website project with a collapsible responsive side menu, smooth scroll transition navigation and animation on sections.
...
# Smooth scroll with animation starter project

...
description: Português. O template base Smooth Scroll oferece a estrutura de um menu nav com links para seções correspondentes da página única e transição de animação suave.
